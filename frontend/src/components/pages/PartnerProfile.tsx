...
export const PartnerProfile = () => {
  ...
  const partner: PartnerDetails = useLocation().state?.partner || null;
  ...
  if (partner) {
    return (
      <>
        ...
        <section className="midsection m-auto max-w-210 xl:max-w-3/5 flex flex-col items-center gap-4 my-4">
          <div className="w-4/5 flex justify-between">
            ...
            <div className="stats">
              <ul>
                <li>Account Balance: {partner.balanceSummary.balance}</li>
                <li>Total Debt: {partner.balanceSummary.debt}</li>
              </ul>
            </div>
            <span>
              <button
          ...
          <table className="table-auto w-4/5 m-2 overflow-x-scroll border-collapse">
            <thead>
              <tr className="bg-amber-400">
                ...
                <th className="px-2 text-right">Date of purchase</th>
